...
public class SmeoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smeo);
        ...
        {
            String url = "http://api.openweathermap.org/data/2.5/weather?lat=49.016667&lon=0.65&appid=b7d1a5da596d0f045ad99a42e9d40d57&units=Imperial";
